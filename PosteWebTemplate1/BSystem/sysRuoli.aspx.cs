...
{
  public partial class sysRuoli : BPageTableBase
  {

    //DEFINIZIONE DATI
    private const string K_TBL = "sysRuoli";
    ...
    {
      this.PageName = "sysRuoli";
      this.CtlCommandBar.PageName = "Gestione Ruoli";
      ...
      this.BCtlsysRuoli.CtlBtnElimina = this.CtlCommandBar.CtlBtnElimina;
      this.BCtlsysRuoli.CtlBtnSalva = this.CtlCommandBar.CtlBtnSalva;
      this.BCtlsysRuoli.CtlBtnAnnulla = this.CtlCommandBar.CtlBtnAnnulla;
      this.BCtlsysRuoli.CtlBtnStampa = this.CtlCommandBar.CtlBtnStampa;
      this.BCtlsysRuoli.Visible = true;
      this.BCtlsysRuoli.Enabled = true;
      return true;
    }
    ...
    protected override void SetAttributes_Invio()
    {
      ...
      this.BCtlsysRuoli.SetAttributes_Invio();

      base.SetAttributes_Invio();
    }
    protected override void SetAttributes_Other()
    {
      this.BCtlsysRuoli.SetAttributes_Other();
    ...
    {
      if (!this.Elimina(
new SqlParameter("@ID", this.BCtlsysRuoli.mbtID.Text)
      ))
      {
      ...
      {
        BSysUtenteEntrato.WriteOperation("RIMOZIONE DEL RECORD IDENTIFICATO DALLA CHIAVE <<[ID] = " + this.BCtlsysRuoli.mbtID.Text + ";>> DELLA TABELLA sysRuoli");
        this.Annulla();
      }
    }
    ...
    private void CtlCommandBar_Salva() //Handles CtlCommandBar.Salva
    {
      ...
      if (this.StatoDetails == eStatusDetails.NUOVO)
        Obj = new BsysRuoli(this.DB);
      else
        Obj = new BsysRuoli(BConvert.ToInt(BCtlsysRuoli.mbtID.Text), this.DB);
      if (this.Salva(Obj))
        this.Annulla();
      else
