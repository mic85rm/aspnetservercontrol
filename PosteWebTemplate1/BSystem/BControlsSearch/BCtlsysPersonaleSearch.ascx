<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BCtlsysPersonaleSearch.ascx.cs" Inherits="PosteWebTemplate1.BCtlsysPersonaleSearch" %>
    ...
    <BWC:BCollapsiblePanel ID="bcpRicerca" runat="server" CssClass="Page_Ricerca BMarginBottom50" Titolo="Ricerca:">
      <Content>
        <asp:Panel ID="PnlRicercaInternal" runat="server" Class="BFloatLeft BWidth100-40 BMarginLeft20">
          <div class="BLabelControl BNextControlGoDown BTesto10 BCollapseSmartPhone TestoDefault" style="width: 200px;">Matricola</div>
          <div class="BInputControl BNextControlGoDown" style="width: calc(100% - 220px);">
            <BWC:BTesto ID="mbtMatricolaRicerca" runat="server"
              Style=""
