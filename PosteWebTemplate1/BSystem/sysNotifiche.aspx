<%@ Page Title="FrmsysNotifiche" Language="C#" AutoEventWireup="false" MasterPageFile="~/Web.Master" CodeBehind="sysNotifiche.aspx.cs" Inherits="PosteWebTemplate1.sysNotifiche" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="AJX" %>
<%@ Register Src="~/BSystem/Controls/CtlCommandBar.ascx" TagName="CtlCommandBar" TagPrefix="CCB" %>
<%@ Register Src="~/BSystem/BControls/BCtlsysNotifiche.ascx" TagPrefix="CCB" TagName="BCtlsysNotifiche" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ctnMain" runat="server">
  <asp:Panel ID="PnlContainer" runat="server" CssClass="BPanelContainerBase">
      ...
      <BWC:BCollapsiblePanel ID="bcpRicerca" runat="server" CssClass="Page_Ricerca" Titolo="Ricerca:">
        <Content>
          <asp:Panel ID="PnlRicercaInternal" runat="server" Class="BFloatLeft BWidth100-40 BMarginLeft20">
            ...
            <label class="BLabelControlSearch BNextControlGoDown BCollapseSmartPhone Testo10 TestoDefault" style="width: 100px;">Descrizione</label>
            <BWC:BTesto ID="mbtDescrizioneRicerca" runat="server"
              Style="width: calc(100% - 180px);"
              INVIO="True"
              CssClass="BInputControl BNextControlGoDown BSetPlaceHolderOnSmartphone Testo10 TestoDefault"
              CssHelpButton=""
    ...
    <asp:Panel ID="PnlDettaglio" runat="server" CssClass="Page_Dettaglio">
      <CCB:BCtlsysNotifiche runat="server" ID="BCtlsysNotifiche" Visible="True" />
    </asp:Panel>
  </asp:Panel>
</asp:Content>
