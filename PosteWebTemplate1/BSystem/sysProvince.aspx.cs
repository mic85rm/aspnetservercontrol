...
{
  public partial class sysProvince : BPageTableBase
  {

    //DEFINIZIONE DATI
    private const string K_TBL = "sysProvince";
    ...
    {
      this.PageName = "sysProvince";
      this.CtlCommandBar.PageName = "Gestione Province";
      ...
      this.BCtlsysProvince.CtlBtnElimina = this.CtlCommandBar.CtlBtnElimina;
      this.BCtlsysProvince.CtlBtnSalva = this.CtlCommandBar.CtlBtnSalva;
      this.BCtlsysProvince.CtlBtnAnnulla = this.CtlCommandBar.CtlBtnAnnulla;
      this.BCtlsysProvince.CtlBtnStampa = this.CtlCommandBar.CtlBtnStampa;
      this.BCtlsysProvince.Visible = true;
      this.BCtlsysProvince.Enabled = true;
      return true;
    }
    ...
    protected override void SetAttributes_Invio()
    {
      ...
      this.BCtlsysProvince.SetAttributes_Invio();

      base.SetAttributes_Invio();
    }
    protected override void SetAttributes_Other()
    {
      this.BCtlsysProvince.SetAttributes_Other();
    ...
    {
      if (!this.Elimina(
          new SqlParameter("@ID", this.BCtlsysProvince.mbtID.Text)
      ))
      {
      ...
      {
        BSysUtenteEntrato.WriteOperation("RIMOZIONE DEL RECORD IDENTIFICATO DALLA CHIAVE <<[ID] = " + this.BCtlsysProvince.mbtID.Text + ";>> DELLA TABELLA sysProvince");
        this.Annulla();
      }
    }
    ...
    {
      BsysProvince Obj = null;
      if (this.StatoDetails == eStatusDetails.NUOVO)
        Obj = new BsysProvince(this.DB);
      else
        Obj = new BsysProvince(BCtlsysProvince.mbtID.Text, this.DB);
      if (this.Salva(Obj))
        this.Annulla();
      else
        ...
        case "BEDIT":
          {
            ...
            obj = new BsysProvince(ID, this.DB);
            this.Modifica(obj);
            break;
          }
        case "BVIEW":
