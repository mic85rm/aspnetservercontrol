<%@ Page Title="Sistemi" Language="C#" AutoEventWireup="false" MasterPageFile="~/Web.Master" CodeBehind="sysSistemi.aspx.cs" Inherits="PosteWebTemplate1.sysSistemi" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="AJX" %>
<%@ Register Src="~/BSystem/Controls/CtlCommandBar.ascx" TagName="CtlCommandBar" TagPrefix="CCB" %>
<%@ Register Src="~/BSystem/BControls/BCtlsysSistemi.ascx" TagPrefix="CCB" TagName="BCtlsysSistemi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ctnMain" runat="server">
  <asp:Panel ID="PnlContainer" runat="server" CssClass="BPanelContainerBase">
    ...
    <asp:Panel ID="PnlElenco" runat="server" CssClass="Page_Elenco">
      <BWC:BGridView ID="DtgElenco" runat="server" AutoGenerateColumns="False" ShowFooter="False" ShowHeaderWhenEmpty="True"
    ...
    <asp:Panel ID="PnlDettaglio" runat="server" CssClass="Page_Dettaglio">
      <CCB:BCtlsysSistemi runat="server" ID="BCtlsysSistemi" Visible="True" />
    </asp:Panel>
  </asp:Panel>
</asp:Content>
