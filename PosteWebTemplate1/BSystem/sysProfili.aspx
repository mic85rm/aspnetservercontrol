<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="sysProfili.aspx.cs" Inherits="PosteWebTemplate1.sysProfili" %>

<%@ Register Src="~/BSystem/Controls/CtlCommandBar.ascx" TagName="CtlCommandBar" TagPrefix="CCB" %>
<%@ Register Src="~/BSystem/BControls/BCtlsysProfili.ascx" TagPrefix="CCB" TagName="BCtlsysProfili" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ctnMain" runat="server">
  <asp:Panel ID="PnlContainer" runat="server" CssClass="BPanelContainerBase">
      ...
      <BWC:BCollapsiblePanel ID="bcpRicerca" runat="server" CssClass="Page_Ricerca" Titolo="Ricerca:">
        <Content>
          <asp:Panel ID="PnlRicercaInternal" runat="server" Class="BFloatLeft BWidth100-40 BMarginLeft20">
            ...
            <div class="BLabelControlSearch BNextControlGoDown BCollapseSmartPhone BTesto10 TestoDefault" style="width: 100px;">Descrizione</div>
          ...
          <div class="BFloatLeft BWidth100 BMarginTop20 Page_Ricerca_CommandBar" style="height: 40px;">
            <BWC:BButton ID="BtnSyncProfili" runat="server" Text="Sync Profili" ToolTip="Allinea profili con webpers" style="width: 127px; height: 32px;" CssClass="Page_Ricerca_ButtonSearch BIconIngranaggio BBtnLeft" />
    ...
    <asp:Panel ID="PnlDettaglio" runat="server" CssClass="Page_Dettaglio">
      <CCB:BCtlsysProfili runat="server" ID="BCtlsysProfili" Visible="True" />
    </asp:Panel>
  </asp:Panel>
</asp:Content>
