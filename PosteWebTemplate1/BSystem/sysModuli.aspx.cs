...
{
  public partial class sysModuli : BPageTableBase
  {

    //DEFINIZIONE DATI
    private const string K_TBL = "sysModuli";
    ...
    {
      this.PageName = "sysModuli";
      this.CtlCommandBar.PageName = "Gestione Moduli";
      ...
      this.BCtlsysModuli.CtlBtnElimina = this.CtlCommandBar.CtlBtnElimina;
      this.BCtlsysModuli.CtlBtnSalva = this.CtlCommandBar.CtlBtnSalva;
      this.BCtlsysModuli.CtlBtnAnnulla = this.CtlCommandBar.CtlBtnAnnulla;
      this.BCtlsysModuli.CtlBtnStampa = this.CtlCommandBar.CtlBtnStampa;
      this.BCtlsysModuli.Visible = true;
      this.BCtlsysModuli.Enabled = true;
      return true;
    }
    ...
    protected override void SetAttributes_Invio()
    {
      ...
      this.BCtlsysModuli.SetAttributes_Invio();

      base.SetAttributes_Invio();
    }
    protected override void SetAttributes_Other()
    {
      this.BCtlsysModuli.SetAttributes_Other();
    ...
    {
      if (!this.Elimina(
        new SqlParameter("@ID", this.BCtlsysModuli.mbtID.Text)
      ))
      {
      ...
      {
        BSysUtenteEntrato.WriteOperation("RIMOZIONE DEL RECORD IDENTIFICATO DALLA CHIAVE <<[ID] = " + this.BCtlsysModuli.mbtID.Text + ";>> DELLA TABELLA sysModuli");
        this.Annulla();
      }
    }
    private void CtlCommandBar_Salva() //Handles CtlCommandBar.Salva
    {
      ...
      if (this.StatoDetails == eStatusDetails.NUOVO)
        Obj = new BsysModuli(this.DB);
      else
        Obj = new BsysModuli(BConvert.ToInt(this.BCtlsysModuli.mbtID.Text), this.DB);
