...
{
  public partial class sysPolicyPwd : BPageTableBase
  {

    //DEFINIZIONE DATI
    private const string K_TBL = "sysPolicyPwd";
    ...
    {
      this.PageName = "sysPolicyPwd";
      this.CtlCommandBar.PageName = "Gestione Policy Password";
      ...
      this.BCtlsysPolicyPwd.CtlBtnElimina = this.CtlCommandBar.CtlBtnElimina;
      this.BCtlsysPolicyPwd.CtlBtnSalva = this.CtlCommandBar.CtlBtnSalva;
      this.BCtlsysPolicyPwd.CtlBtnAnnulla = this.CtlCommandBar.CtlBtnAnnulla;
      this.BCtlsysPolicyPwd.CtlBtnStampa = this.CtlCommandBar.CtlBtnStampa;
      this.BCtlsysPolicyPwd.Visible = true;
      this.BCtlsysPolicyPwd.Enabled = true;
      return true;
    }
    ...
    protected override void SetAttributes_Invio()
    {
      ...
      this.BCtlsysPolicyPwd.SetAttributes_Invio();

      base.SetAttributes_Invio();
    }
    protected override void SetAttributes_Other()
    {
      this.BCtlsysPolicyPwd.SetAttributes_Other();
    ...
    {
      if (!this.Elimina(
new SqlParameter("@ID", this.BCtlsysPolicyPwd.mbtID.Text)
      ))
      {
      ...
      {
        BSysUtenteEntrato.WriteOperation("RIMOZIONE DEL RECORD IDENTIFICATO DALLA CHIAVE <<[ID] = " + this.BCtlsysPolicyPwd.mbtID.Text + ";>> DELLA TABELLA sysPolicyPwd");
        this.Annulla();
      }
    }
    ...
    {
      BsysPolicyPwd Obj = null;
      if (this.StatoDetails == eStatusDetails.NUOVO)
        Obj = new BsysPolicyPwd(this.DB);
      else
        Obj = new BsysPolicyPwd(BConvert.ToInt(BCtlsysPolicyPwd.mbtID.Text), this.DB);
      if (this.Salva(Obj))
        this.Annulla();
      else
        ...
        case "BEDIT":
          {
            ...
            obj = new BsysPolicyPwd(ID, this.DB);
            if (obj != null)
            {
              if (obj.Sistema)
                this.Visiona(obj);
